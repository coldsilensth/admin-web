...
INSERT INTO users (username, password, enabled) values ('user','{bcrypt}$2a$12$OSXM0Ymh31helDAIcDaG1.IluDbFkc091TySjTeNjdjtuvf8.XeOS','true');
INSERT INTO users (username, password, enabled) values ('admin','{bcrypt}$2a$12$z48lAYC7KyM0UxT96Kzc3.3hP/Vi2iG5dBl/V1BHubhXIxrNojjua','true');
